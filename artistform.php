        ...
        <div class="collectInfo">
            ...
            <hr>
             ...
             <h2>LogIn Type:  <select name="usertype" required>
                ...
                <option value="SignUp as Artist">Artist</option>
             </select></h2> 
             <h2><input type="checkbox" id="CheckBox" name="CheckBox" required/>
                <label for="CheckBox"> You Are Agree To Sold Your Painting On Our Website?</label></h2>
             <div class="btn">
